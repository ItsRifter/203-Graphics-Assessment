...
void Model::render(bool enableWireframe)
{
...
#pragma region unroll_data
	...
	for (size_t i = 0; i < faces.size(); i += 3)
	{
		...
		normals.push_back(curnormsIndex.x);
		normals.push_back(curnormsIndex.y);
		normals.push_back(curnormsIndex.z);

		texCoords.push_back(curTexCoords.x);
		texCoords.push_back(curTexCoords.y);
	}
